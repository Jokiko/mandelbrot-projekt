...
public class MethodsUI {
	 ...
	 */
	static BufferedImage I = new BufferedImage(UI.imgPicture.getWidth(), UI.imgPicture.getHeight(),
	...
	/**
	 * plotValRe() TODO Testzwecke (am Ende loeschen/auskommentieren)
	 */
	...
	/**
	 * plotPoints() berechnet die Mandelbrotmenge (am Ende loeschen/auskommentieren)
	 */
...
//		// zeichnet Kreuz ueber das Bild (Testzwecke)
	...
	/**
	 * imgPanel stellt die Mandelbrotmenge dar
	 */
	...
	public static void zoomIn(double factor) {
		...
		/*
		 * if(!rectangle) { ServerThread.sendMessageText("zoomIn/.../" + factor);
		 * ServerThreadWebSocket.sendMessageText("zoomIn/.../" + factor); }else{
		 * ServerThread.sendMessageText("rectangle/.../" + xMove + "/.../" + yMove +
		 * "/.../" + factor); ServerThreadWebSocket.sendMessageText("rectangle/.../" +
		 * xMove + "/.../" + yMove + "/.../" + factor); }//
		 */
