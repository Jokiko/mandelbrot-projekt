...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item[b)] wenn Emulator noch nicht erstellt
			...
			\item[6.] klicke „next“
			\item[7.] klicke „finish“
			\end{itemize}
		\item[c)] falls gewünscht kann mithilfe von „Run on Multiple Devices“ die App auf mehreren Geräten gleichzeitig gestartet werden
			\begin{itemize}
			\item[1.] auf „Run on Multiple Devices“ klicken
			\item[2.] alle gewünschten Geräte auswählen
			\item[3.] auf „run“ klicken (App wird installiert und öffnet automatisch)
			\begin{itemize}
